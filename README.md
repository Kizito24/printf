...
|`itoa.c`| Function that converts an integer to a string.|`None` |
|`count.c` | Contains a string length cuonting function. | `None` | 
|`sprintf.c` | Function that dupicates and prints a string. | `None` |
...
- Chiazor Kizito Chinoyelum : kizitochiazor@gmail.com
- Oluwakayode
