...
/**
 * _printf_S_x - a function that prints Non printable ASCII characters to stdout.
 * @num: the non printable characters to print.
 *
 * Return: number of successfully printed characters.
 */
int printf_unprint_char(unsigned int num)
{
